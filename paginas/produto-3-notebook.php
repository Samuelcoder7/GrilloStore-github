...
<head>
    ...
    <title id="page-title">Notebook Acer Aspire Go - Grillo Store</title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../estilo/style-produto.css">
    <link rel="icon" type="image/x-icon" href="../imagens-produtos/note1.jpg">
</head>
<body>
    <header class="header">
        <div class="header-content">
            <a href="listagemlistagem.php" class="logo">Grillo Store</a>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                <div class="thumbnail-gallery" id="thumbnail-gallery">
                    ...
                    <img src="../imagens-produtos/note1.jpg" alt="Notebook Acer Aspire Go" class="thumbnail-image" data-full="../../imagens-produtos/imagem/note1.jpg">
                    <img src="../imagens-produtos/note2.jpg" alt="Notebook Acer Aspire Go" class="thumbnail-image" data-full="../../imagens-produtos/imagem/note2.jpg">
                    <img src="../imagens-produtos/note3.jpg" alt="Notebook Acer Aspire Go" class="thumbnail-image" data-full="../../imagens-produtos/imagem/note3.jpg">
                    <img src="../imagens-produtos/note4.jpg" alt="Notebook Acer Aspire Go" class="thumbnail-image" data-full="../../imagens-produtos/imagem/note4.jpg">
                </div>
                <div class="main-image-container">
                    <img src="../imagens-produtos/note1.jpg" alt="Notebook Acer Aspire Go" class="main-product-image" id="main-product-image">
                </div>
            </div>
            ...
            <aside class="purchase-sidebar">
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-3-notebook.php" class="buy-now-button">Comprar Agora</a>
