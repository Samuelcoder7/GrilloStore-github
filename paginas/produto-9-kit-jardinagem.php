...
<head>
    ...
    <title id="page-title">Kit De Jardinagem 10 Peças + Maleta - Grillo Store</title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../estilo/style-produto.css">
    <link rel="icon" type="image/x-icon" href="../imagens-produtos/jardinagem/maleta .jpg">
</head>
<body>
    <header class="header">
        <div class="header-content">
            <a href="listagem.php" class="logo">Grillo Store</a>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                <div class="thumbnail-gallery" id="thumbnail-gallery">
                    <img src="../imagens-produtos/maleta .jpg" alt="Kit De Jardinagem 10 Peças" class="thumbnail-image" data-full="../../imagens-produtos/jardinagem/maleta .jpg">
                    <img src="../imagens-produtos/pas.jpg" alt="Kit De Jardinagem 10 Peças" class="thumbnail-image" data-full="../../imagens-produtos/jardinagem/pas.jpg">
                    <img src="../imagens-produtos/rastelo.jpg" alt="Kit De Jardinagem 10 Peças" class="thumbnail-image" data-full="../../imagens-produtos/jardinagem/rastelo.jpg">
                    <img src="../imagens-produtos/faca.jpg" alt="Kit De Jardinagem 10 Peças" class="thumbnail-image" data-full="../../imagens-produtos/jardinagem/faca.jpg">
                </div>
                <div class="main-image-container">
                    <img src="../imagens-produtos/maleta .jpg" alt="Kit De Jardinagem 10 Peças + Maleta" class="main-product-image" id="main-product-image">
                </div>
            </div>
              
            <div class="product-info-details">
                <h1 class="product-title" id="product-title">Kit De Jardinagem 10 Peças + Maleta</h1>
            ...
            <aside class="purchase-sidebar">
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-9-kit-jardinagem.php" class="buy-now-button">Comprar Agora</a>
