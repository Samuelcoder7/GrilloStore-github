...
<head>
    ...
    <title id="page-title">Macaco Elétrico 2 Toneladas 12v 100w Controle Carro- Grillo Store</title>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                <div class="thumbnail-gallery" id="thumbnail-gallery">
                    <img src="../imagens-produtos/macaco1.jpg" alt="Macaco Elétrico 2 Toneladas 12v 100w Controle Carro" class="thumbnail-image" data-full="../../imagens-produtos/imagem/macaco1.jpg">
                    <img src="../imagens-produtos/macaco2.jpg" alt="Macaco Elétrico 2 Toneladas 12v 100w Controle Carro" class="thumbnail-image" data-full="../../imagens-produtos/imagem/macaco2.jpg">
                    <img src="../imagens-produtos/macaco3.jpg" alt="Macaco Elétrico 2 Toneladas 12v 100w Controle Carro" class="thumbnail-image" data-full="../../imagens-produtos/imagem/macaco3.jpg">
                    <img src="../imagens-produtos/macaco4.jpg" alt="Macaco Elétrico 2 Toneladas 12v 100w Controle Carro" class="thumbnail-image" data-full="../../imagens-produtos/imagem/macaco4.jpg">
                </div>
                <div class="main-image-container">
                    <img src="../imagens-produtos/macaco1.jpg" alt="Macaco Elétrico 2 Toneladas 12v 100w Controle Carro" class="main-product-image" id="main-product-image">
                </div>
            </div>

            <div class="product-info-details">
                <h1 class="product-title" id="product-title">Macaco Elétrico 2 Toneladas 12v 100w Controle Carro</h1>
                <div class="price-section">
                    <p class="price-label">À vista</p>
                    <p class="price-value" id="price-value">R$ 379,99</p>
                ...
                <div class="product-specs">
                    ...
                    <ul class="specs-list" id="specs-list">
                        <li>Marca BT Shop </li>
                        <li>Macaco elétrico</li>
                        <li>3 fusíveis</li>
                        <li>Cabo de alimentação veicular</li>
                        <li>manual em inglês</li>
                    </ul>
                </div>
            </div>
            ...
            <aside class="purchase-sidebar">
                <div class="sidebar-price-block">
                    <div class="current-price-display">
                        <span class="current-price" id="current-price-sidebar">R$ 379,99</span>
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto7-macacao-eletrico.php" class="buy-now-button">Comprar Agora</a>
