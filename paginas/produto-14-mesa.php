...
<head>
    ...
    <title id="page-title">Conjunto Sala de Jantar Cel Móveis com 08 Cadeiras Mesa de Cinamomo/off White/suede Animale- Grillo Store</title>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                ...
                <div class="main-image-container">
                    <img src="../imagem/camisa1.jpg" alt="Conjunto Sala de Jantar Cel Móveis com 08 Cadeiras Mesa de Cinamomo/off White/suede Animale" class="main-product-image" id="main-product-image">
                </div>
            </div>

            <div class="product-info-details">
                <h1 class="product-title" id="product-title">Conjunto Sala de Jantar Cel Móveis com 08 Cadeiras Mesa de Cinamomo/off White/suede Animale</h1>
                <div class="price-section">
                    <p class="price-label">À vista</p>
                    <p class="price-value" id="price-value">R$ 2.642,48</p>
                ...
                <div class="product-specs">
                    <p class="spec-color" id="product-color">Cor:<span class="spec-value" id="product-color-value">Madeira</span></p>
                    <h2 class="specs-title">O que você precisa saber sobre este produto</h2>
                    <ul class="specs-list" id="specs-list">
                        <li>Forma da mesa: retangular.</li>
                        <li>Materiais das cadeiras: madeira</li>
                        <li>Incluí estofamento.</li>
                        <li>Dimensões das cadeiras: 77cm x 61cm x 53cm.</li>
            ...
            <aside class="purchase-sidebar">
                <div class="sidebar-price-block">
                    <div class="current-price-display">
                        <span class="current-price" id="current-price-sidebar">R$ 1851,85</span>
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-14-mesa.php" class="buy-now-button">Comprar Agora</a>
