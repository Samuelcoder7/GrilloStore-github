...
<head>
    ...
    <title id="page-title">Sony PlayStation 4 Pro 1TB Standard cor preto onyx 2020- Grillo Store</title>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                ...
                <div class="main-image-container">
                    <img src="../imagem/camisa1.jpg" alt="Sony PlayStation 4 Pro 1TB Standard cor preto onyx 2020" class="main-product-image" id="main-product-image">
                </div>
            </div>

            <div class="product-info-details">
                <h1 class="product-title" id="product-title">Sony PlayStation 4 Pro 1TB Standard cor preto onyx 2020</h1>
                <div class="price-section">
                    <p class="price-label">À vista</p>
                    <p class="price-value" id="price-value">R$ 2.499</p>
                ...
                <div class="product-specs">
                    ...
                    <ul class="specs-list" id="specs-list">
                        ...
                        <li>Inclui cabo **HDMI** e cabo de alimentação para imediata utilização.</li>
            ...
            <aside class="purchase-sidebar">
                <div class="sidebar-price-block">
                    <div class="current-price-display">
                        <span class="current-price" id="current-price-sidebar">R$ 2.499</span>
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-15-game.php" class="buy-now-button">Comprar Agora</a>
