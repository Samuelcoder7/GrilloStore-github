...
<head>
    ...
    <title id="page-title">Caixa de Som Amplificada Bluetooth USB LED RGB - Grillo Store</title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../estilo/style-produto.css">
    <link rel="icon" type="image/x-icon" href="../imagens-produtos/caixa-som/caixa1.jpg">
</head>
<body>
    <header class="header">
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                <div class="thumbnail-gallery" id="thumbnail-gallery">
                    <img src="../imagens-produtos/caixa1.jpg" alt="Caixa de Som Amplificada no Tripé" class="thumbnail-image active" data-full="../../imagens-produtos/caixa-som/caixa1.jpg">
                    <img src="../imagens-produtos/caixa2.jpg" alt="Caixa de Som com Microfone e LED Azul" class="thumbnail-image" data-full="../../imagens-produtos/caixa-som/caixa2.jpg">
                    <img src="../imagens-produtos/caixa3.jpg" alt="Dimensões da Caixa de Som" class="thumbnail-image" data-full="../../imagens-produtos/caixa-som/caixa3.jpg">
                    <img src="../imagens-produtos/caixa4.jpg" alt="Entradas USB, Micro SD e Microfone" class="thumbnail-image" data-full="../../imagens-produtos/caixa-som/caixa4.jpg">
                    <img src="../imagens-produtos/caixa5.jpg" alt="Caixa de Som com Compartimento para Microfone" class="thumbnail-image" data-full="../../imagens-produtos/caixa-som/caixa5.jpg">
                </div>
                <div class="main-image-container">
                    <img src="../imagens-produtos/caixa1.jpg" alt="Caixa de Som Amplificada Portátil" class="main-product-image" id="main-product-image">
                </div>
            </div>
              
            <div class="product-info-details">
                <h1 class="product-title" id="product-title">Caixa de Som Amplificada Bluetooth USB LED RGB</h1>
            ...
            <aside class="purchase-sidebar">
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-12-caixa-de-som.php" class="buy-now-button">Comprar Agora</a>
