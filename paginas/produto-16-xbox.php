...
<head>
    ...
    <title id="page-title">Microsoft Xbox 360 Super Slim 250GB Standard cor preto 2010- Grillo Store</title>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                ...
                <div class="main-image-container">
                    <img src="../imagem/camisa1.jpg" alt="Microsoft Xbox 360 Super Slim 250GB Standard cor preto 2010" class="main-product-image" id="main-product-image">
                </div>
            </div>

            <div class="product-info-details">
                <h1 class="product-title" id="product-title">Microsoft Xbox 360 Super Slim 250GB Standard cor preto 2010</h1>
                <div class="price-section">
                    <p class="price-label">À vista</p>
                    <p class="price-value" id="price-value">R$ 1.190.00</p>
            ...
            <aside class="purchase-sidebar">
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-16-xbox.php" class="buy-now-button">Comprar Agora</a>
