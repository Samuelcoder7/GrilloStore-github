...
<head>
    ...
    <title id="page-title">Kit Camiseta Básica c/ 5 Peças - Grillo Store</title>
    ...
    <main class="product-page-container">
       ...
       <div class="product-content-wrapper">
            ...
            <div class="product-images">
                ...
                <!--Aqui coloque as umagens de camisa -->    
                    <img src="../imagens-produtos/camisa1.jpg" alt="Kit 4 Camisetas Feminina Academia - Atacado" class="thumbnail-image" data-full="../../imagens-produtos/imagem/camisa1.jpg">
                    <img src="../imagens-produtos/camisa2.jpg" alt="Kit 4 Camisetas Feminina Academia - Atacado" class="thumbnail-image" data-full="../../imagens-produtos/imagem/camisa2.jpg">
                    <img src="../imagens-produtos/camisa3.jpg" alt="Kit 4 Camisetas Feminina Academia - Atacado" class="thumbnail-image" data-full="../../imagens-produtos/imagem/camisa3.jpg">
                    <img src="../imagens-produtos/camisa4.jpg" alt="Kit 4 Camisetas Feminina Academia - Atacado" class="thumbnail-image" data-full="../../imagens-produtos/imagem/camisa4.jpg">
                </div>
                <div class="main-image-container">
                   <img src="../imagens-produtos/camisa1.jpg" alt="Kit 4 Camisetas Feminina Academia - Atacado" class="main-product-image" id="main-product-image">
                </div>
            </div>
            ...
            <aside class="purchase-sidebar">
                <div class="sidebar-price-block">
                    <div class="current-price-display">
                        <span class="current-price" id="current-price-sidebar">R$ 47,49</span>
                ...
                <div class="action-buttons">
                    <!-- Botão atualizado para checkout -->
                    <a href="checkout.php?produto=produto-1-camiseta-basica.php" class="buy-now-button">Comprar Agora</a>
