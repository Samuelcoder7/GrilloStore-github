...
<head>
    ...
    <title id="page-title">Mangueira Flexível Tramontina 15m Flex - Grillo Store</title>
        ...
        <div class="product-content-wrapper">
            ...
            <div class="product-images">
                <div class="thumbnail-gallery" id="thumbnail-gallery">
                    <img src="../imagens-produtos/mangueira_1.jpg" alt="Mangueira Flexível Tramontina" class="thumbnail-image active" data-full="../../imagens-produtos/borracha/mangueira_1.jpg">
                    <img src="../imagens-produtos/mangueira_2.jpg" alt="Detalhe da Embalagem da Mangueira" class="thumbnail-image" data-full="../../imagens-produtos/borracha/mangueira_2.jpg">
                    <img src="../imagens-produtos/mangueira_3.jpg" alt="Camadas da Mangueira Tramontina" class="thumbnail-image" data-full="../../imagens-produtos/borracha/mangueira_3.jpg">
                </div>
                <div class="main-image-container">
                    <img src="../imagens-produtos/mangueira_1.jpg" alt="Mangueira Flexível Tramontina 15m Flex" class="main-product-image" id="main-product-image">
                </div>
            </div>
            ...
            <aside class="purchase-sidebar">
                ...
                <div class="action-buttons">
                    <a href="checkout.php?produto=produto-10-mangueira.php" class="buy-now-button">Comprar Agora</a>
